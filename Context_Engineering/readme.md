...
## 1. Background: The Road from Prompt Engineering to Context Engineering

<details>
<summary><strong>expand</strong></summary>

To understand Context Engineering, it helps to trace its evolution from earlier approaches.
- Start with its predecessor: prompt engineering
- Examine where prompt engineering falls short
- Consider the obvious alternatives — and why they fail
- Arrive at Context Engineering as a concept
...
### 1.2. Limitation of Prompt Enginnering?
...
If the context window is large enough, why not just feed everything in?
...
<details>
<summary><strong>analogy</strong></summary>
...
**Big picture: Context Engineering as an OS**
...
More details, what are the components of context engineering? how to build context engineering


### 2.1. Static design: three pillars for effective context
...
### 2.2. Dynamic design: retrieving context at runtime
...
Common Problems for longer context
